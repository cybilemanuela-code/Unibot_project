<template>
  <!--
    ...
    Split layout: orange hero left | form right
    Fully responsive: hero hides on mobile, form takes full width
  -->
  <div class="min-h-screen grid md:grid-cols-[55%_45%] bg-surface-50">
    ...
    <div class="flex flex-col min-h-screen">
      ...
      <!-- Top nav (mobile: show logo; desktop: show nav links) -->
      <nav class="flex items-center justify-between px-8 py-5">
        <!-- Mobile-only logo -->
        <UnibotLogo class="md:hidden" />
        <div class="hidden md:block" />
        <div class="flex items-center gap-6 text-sm text-gray-500">
          <RouterLink to="/app/support" class="hover:text-gray-800 transition-colors">
            Campus Directory
          </RouterLink>
          <RouterLink to="/login"
            class="text-brand-500 font-semibold hover:text-brand-600 transition-colors">
            Sign In
          </RouterLink>
        </div>
      </nav>
      ...
      <div class="flex-1 flex items-center justify-center px-8 py-6">
        <div class="w-full max-w-md page-enter">
          ...
          <!-- Heading -->
          <div class="mb-8">
            <h2 class="font-display text-3xl text-gray-900 mb-2">Create your account</h2>
            <p class="text-sm text-gray-500 leading-relaxed">
              Enter your details to get started with your academic concierge.
            </p>
          </div>
      ...
      <!-- Footer -->
      <footer class="px-8 py-5 border-t border-surface-200">
        <p class="text-xs text-gray-400 text-center">
          © 2024 UNIBOT ACADEMIC CONCIERGE. ALL RIGHTS RESERVED.
        </p>
      </footer>
    </div>
  </div>
...
import UnibotLogo        from '@/components/common/UnibotLogo.vue'
